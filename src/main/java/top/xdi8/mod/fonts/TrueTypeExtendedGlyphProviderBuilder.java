...
@OnlyIn(Dist.CLIENT)
public class TrueTypeExtendedGlyphProviderBuilder implements GlyphProviderBuilder {
   ...
   public TrueTypeExtendedGlyphProviderBuilder(ResourceLocation pLocation, float pSize, float pOversample, float pShiftX, float pShiftY, String pSkip) {
   ...
   public static GlyphProviderBuilder fromJson(JsonObject pJson) {
      ...
      return new TrueTypeExtendedGlyphProviderBuilder(new ResourceLocation(GsonHelper.getAsString(pJson, "file")), GsonHelper.getAsFloat(pJson, "size", 11.0F), GsonHelper.getAsFloat(pJson, "oversample", 1.0F), f, f1, stringbuilder.toString());
   }

   @Nullable
   public GlyphProvider create(@NotNull ResourceManager pResourceManager) {
      ...
      try {
         ...
         try {
            ...
            truetypeglyphprovider = new TrueTypeExtendedGlyphProvider(bytebuffer, stbttfontinfo, this.size, this.oversample, this.shiftX, this.shiftY, this.skip);
