...
@ApiStatus.Internal
public class Xdi8MixinConfig implements IMixinConfigPlugin {
    private boolean shouldApply;
    private static final String MUI_ID = "modernui";
    ...
    public void onLoad(String mixinPackage) {
        shouldApply = FMLEnvironment.dist.isClient()
                && ModList.get().isLoaded(MUI_ID);
    }
