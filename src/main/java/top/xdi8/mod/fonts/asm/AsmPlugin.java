...
public class AsmPlugin implements IMixinConfigPlugin {
    ...
    public void preApply(String targetClassName, ClassNode targetClass, String mixinClassName, IMixinInfo mixinInfo) {
        if ("top.xdi8.mod.fonts.asm.fake.Wrapper".equals(mixinClassName)) {
            if ("net.minecraft.client.gui.font.providers.GlyphProviderBuilderType".equals(targetClassName))
                new HackGlyphProviderBuildType().accept(targetClass);
        }
    }
