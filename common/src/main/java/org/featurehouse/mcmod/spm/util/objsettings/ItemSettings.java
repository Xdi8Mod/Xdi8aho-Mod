...
public final class ItemSettings {
    public static Properties groupFood() {
        return new Properties().tab(CreativeModeTab.TAB_FOOD);
    }

    public static Properties oneFood() {
        return new Properties().tab(CreativeModeTab.TAB_FOOD).stacksTo(1);
    }

    public static Properties decorations() {
        return new Properties().tab(CreativeModeTab.TAB_DECORATIONS);
    }

    public static Properties uncommonDecorations() {
        return new Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON);
    }
